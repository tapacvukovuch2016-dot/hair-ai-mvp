...
st.title("✂️ Hair AI")
st.caption("MVP v0.33 — Hairline Preserve")
            ...
            if st.button("✨ Показать на мне",key="try_"+rec["id"],use_container_width=True):
                try:
                    ...
                    if out:
                        ...
                        st.caption("v0.33 Hairline Preserve: линия роста и виски считаются фиксированной геометрией исходного человека. Если граница неясна, AI должен сохранять исходный переход, а не придумывать новый угол.")
...
st.caption("v0.33 — Hairline Preserve: сохраняет исходную линию роста и виски; при неопределённости не дорисовывает новую геометрию.")
