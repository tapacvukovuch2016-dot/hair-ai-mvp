...
st.title("✂️ Hair AI")
st.caption("MVP v0.29 — Photoreal Hair Texture")
            ...
            if st.button("✨ Показать на мне",key="try_"+rec["id"],use_container_width=True):
                try:
                    ...
                    if out:
                        ...
                        st.caption("v0.29 Photoreal Texture: сохраняет маску и линию роста волос из v0.28, но делает сами волосы менее равномерными и более натуральными.")
...
st.caption("v0.29 — Photoreal Texture: естественная плотность, лёгкая видимость кожи головы, разное направление и длина отдельных волосков.")
