...
st.title("✂️ Hair AI")
st.caption("MVP v0.34 — Hairstyle Identity")
            ...
            if st.button("✨ Показать на мне",key="try_"+rec["id"],use_container_width=True):
                try:
                    ...
                    if out:
                        ...
                        st.caption("v0.34 Hairstyle Identity: сохраняет защиту лица и линии роста v0.33, но задаёт отдельную геометрию длины, боков, объёма и направления для каждой стрижки.")
...
st.caption("v0.34 — Hairstyle Identity: Crew Cut, Textured Crop и Classic Taper получают различимую геометрию, сохраняя защиту лица и естественной линии роста v0.33.")
