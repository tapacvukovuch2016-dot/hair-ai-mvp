...
st.title("✂️ Hair AI")
st.caption("MVP v0.24 — Realism + Analysis Cache")
            ...
            if st.button("✨ Показать на мне",key="try_"+rec["id"],use_container_width=True):
                try:
                    ...
                    if out:
                        ...
                        st.caption("v0.24 Realism: кэш анализа волос + более строгая сохранность лица, лба, головы и фона.")
...
st.caption("v0.24 — Realism + Cache: повторные примерки используют кэш анализа; генерация строже сохраняет лицо, линию лба, форму головы и фон.")
