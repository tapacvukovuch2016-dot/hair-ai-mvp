...
st.title("✂️ Hair AI")
st.caption("MVP v0.23 — Draft / Fast / HD")
            ...
            if st.button("✨ Показать на мне",key="try_"+rec["id"],use_container_width=True):
                try:
                    ...
                    if out:
                        ...
                        st.caption("v0.23 Balanced: ⚡ Черновик=low, Быстро=medium, HD=high; ускоренная маска, быстрый lossless PNG и кэш готовых примерок.")
...
st.caption("v0.23 — Balanced: три уровня качества при сохранении ускоренной маски, обработки и диагностических таймингов.")
