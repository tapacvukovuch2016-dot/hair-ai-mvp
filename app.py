...
st.title("✂️ Hair AI")
st.caption("MVP v0.28 — Real Hairline")
            ...
            if st.button("✨ Показать на мне",key="try_"+rec["id"],use_container_width=True):
                try:
                    ...
                    if out:
                        ...
                        st.caption("v0.28 Real Hairline: сохраняет Hair-Only Mask и Natural Blend, но делает линию роста волос и виски менее геометричными.")
...
st.caption("v0.28 — Real Hairline: естественная линия роста волос, микроволоски по краю и более мягкий переход у висков.")
