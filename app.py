...
st.title("✂️ Hair AI")
st.caption("MVP v0.31 — Clean Silhouette")
            ...
            if st.button("✨ Показать на мне",key="try_"+rec["id"],use_container_width=True):
                try:
                    ...
                    if out:
                        ...
                        st.caption("v0.31 Clean Silhouette: убирает остатки исходных длинных волос вокруг короткой стрижки, сохраняя лицо, лоб и фон.")
...
st.caption("v0.31 — Clean Silhouette: чистый внешний контур короткой стрижки + защита лица/лба + быстрый fallback анализа волос.")
