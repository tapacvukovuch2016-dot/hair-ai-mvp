...
st.title("✂️ Hair AI")
st.caption("MVP v0.17 — Faster Try-On + Cached Hair Analysis")
...
st.caption("v0.17 — экспериментальный прототип. Кэш анализа волос + Fast/HD режимы. Не оценивает красоту человека.")
