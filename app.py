...
st.title("✂️ Hair AI")
st.caption("MVP v0.16 — Dual-Zone Hair Mask")
            ...
            if st.button("✨ Показать на мне",key="try_"+rec["id"],use_container_width=True):
                try:
                    ...
                    if out:
                        ...
                        st.caption("AI-визуализация — ориентир. v0.16 использует две зоны волос: свободную внутреннюю и мягкую переходную по контуру.")
...
st.caption("v0.16 — экспериментальный прототип. Не оценивает красоту человека.")
